...
for year in range(2003, 2023):
    ...
    for month in range(1, max_month):
        ...
        df_valute = df_valute.pivot_table(index='date', columns='CharCode', values='Value', aggfunc='sum')
        valutes.append(df_valute)
        print(df_valute.head())

df_merge = pd.concat(valutes, ignore_index=False)
print()
